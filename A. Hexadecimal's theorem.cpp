...
int64_t fib(int64_t x){
     return (pow(((1+sqrt(5))/2),x)- (1-sqrt(5)/2))/sqrt(5);
}
double whichfib(int64_t x){
     return (log2(x) + log2(sqrt(5)))/log2((1-sqrt(5))/2);
}
